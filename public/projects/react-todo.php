        ...
        <?php require(get_project_path('public/partials/global/header.php')); ?>
            <main class="react-todo">
                <section class="project-bnr m-top p-top grid align-items-center">
                    ...
                    <img src="<?php echo get_public_url('/images/placeholder.svg'); ?>" data-src="<?php echo get_public_url('images/todo-light-mode.png')?>" class="lazy col-12 col-6-lg" alt="Web preview of light mode of the To-do app">
                </section>
                ...
                <section class="grid">
                    <div class="col-12 col-10-lg">
                        ...
                        <img class="lazy" src="<?php echo get_public_url('/images/placeholder.svg'); ?>" data-src="<?php echo get_public_url('images/todo-code-snippet.png')?>" alt="Screenshot of the useEffect hook code">
