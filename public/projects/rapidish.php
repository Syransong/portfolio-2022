        ...
        <?php require(get_project_path('public/partials/global/header.php')); ?>
            <main class="rapidish">
                <section class="project-bnr m-top grid align-items-center">
                    ...
                    <img src="<?php echo get_public_url('images/rapidish-phone-mockup.png')?>" class="rapidish-mobile" alt="Mobile view of the Rapidish landing page">
                </section>
                ...
                <section class="grid">
                    ...
                    <a href="#" class="col btn live-link">View Live Page</a>
                </section>
                <section class="grid">
                    <div class="col col-10">
